...
class Maplet
{
  ...
  {
    return String.valueOf(String.valueOf(String.valueOf("").concat(String.valueOf(this.domainElement))).concat(String.valueOf(" |-> "))).concat(String.valueOf(this.rangeElement));
  }
}
