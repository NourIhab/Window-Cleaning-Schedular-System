...
public class DeallocateBucketTestCase {
    ...
    public void testDeallocateTeam(){  
      VDMSet team = new VDMSet("engy");
           Job job = new Job("4",true,Priority.HIGH,true,JobType.BUCKET_LADDER,State.COMPLETED,vehicle3,j1StartDate,j1FinishDate,10,8,equipment1,Satisfaction.GOOD,b1,team);

        WindowCleaningService wcs=new WindowCleaningService();
        assertEquals(true, wcs.DeallocateBucketTeam(job));  
    }  
