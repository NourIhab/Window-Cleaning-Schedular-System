...
public class AllocateBucketTestCase {
    ...
    public void AllocateBucket(){  
      ...
      Job job = new Job("1",true,Priority.HIGH,true,JobType.BUCKET_LADDER,State.NEW,vehicle3,j1StartDate,j1FinishDate,10,8,equipment1,Satisfaction.GOOD,b1,team1);
      WindowCleaningService wcs=new WindowCleaningService();
      assertEquals(true, wcs.AllocateBucketTeamtoJob(job));  
