...
class VDMMap
{
  ...
  public String toString()
  {
    ...
    if (enum1.hasMoreElements())
    {
      ...
      mapOut = String.valueOf(String.valueOf(String.valueOf(mapOut).concat(String.valueOf(domElement))).concat(String.valueOf(" |-> "))).concat(String.valueOf(rangeElement));
    }
    while (enum1.hasMoreElements())
    {
      Object domElement = enum1.nextElement();
      Object rangeElement = this.theMap.get(domElement);
      mapOut = String.valueOf(String.valueOf(String.valueOf(String.valueOf(mapOut).concat(String.valueOf(", "))).concat(String.valueOf(domElement))).concat(String.valueOf(" |-> "))).concat(String.valueOf(rangeElement));
    }
